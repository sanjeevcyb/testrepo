...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <header<?php print $header_attributes; ?> class="set-width">
<div class="header-nav">
	...
	<?php
	 if(!$user->uid) { ?>
	  <div class="login-box">
						<div class="login">
							<?php
								/*$login_block = drupal_get_form('user_login_block');
								print drupal_render($login_block);*/

							?>
							<?php print affiliate_theme_one_get_login_block() ;?>
						</div>
						<div class="forgot-password">
							...
							?>
							<?php print affiliate_theme_one_get_forgot_password();?>
							<input class="sign-in Cancel" type="button" value="Cancel">
						</div>
	  </div>    <!--END login-box -->
	<?php }?>
	</div>
  ...
  <div id="columns" class="columns clearfix set-width">
              ...
              <?php //  print $content; 
 		       ...
 		       if($status == '403 Forbidden') {
                     if( arg(1)!= "" && is_numeric(arg(1)) ){
 			            $vnode = node_load(arg(1));
                        if($vnode->type == "video" || $vnode->type == "live_event") {
                            global $user;
                            if($user->uid) {
				               print "Please purchase the product and view this content";
                            } else {
			    	           print "Please login to purchase the product and view this content";
                            }
                        }
			          else {
...
<?php print render($page['image_footer']);?>
</div>
  <?php if ($page['footer']): ?>
