...
<!--[if IE 8]><html class="lt-ie9"<?php print $html_attributes; ?>>
<link rel="stylesheet" type="text/css" href="/sites/all/themes/affiliate_theme_one/css/ie8.css" />
<![endif]-->
<meta name="viewport" content="width=device-width; initial-scale=1; maximum-scale=1.0">
<!--[if (gte IE 9)|(gt IEMobile 7)]><!--><html<?php print $html_attributes . $rdf_namespaces; ?>><!--<![endif]-->
 <head>
 <?php
 $head_title = change_title($variables,'page');
 ?>
<?php print $head; ?>
<title><?php print $head_title['head_title']; ?></title>
<?php print $styles; ?>
<?php
global $base_url;
$js_file_path = $base_url ."/". path_to_theme() ."/". "templates";
?>
<script type="text/javascript" src="<?php echo $js_file_path; ?>/jwplayer/jwplayer.js"></script>
